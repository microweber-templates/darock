    ...
    ?>
        ...
        <div class="mwpgrid-item">
            ...
            <?php if ($show_fields == false or in_array('thumbnail', $show_fields)): ?>
                <a href="<?php print $item['link'] ?>" class="mwpgrid-item-rock-image" style="background-image: url();"><img src="<?php print thumbnail($item['image'], $tn[0], $tn[1]); ?>"
                                                                                                                             alt=""/></a>
            <?php endif; ?>
                ...
                <div class="product-price-holder clearfix">
                    ...
                    <?php if ($show_fields == false or in_array('add_to_cart', $show_fields)): ?>
                        ...
                        <?php if (is_array($item['prices'])): ?>
                            <span class="tip mw-icon-shop " data-tip="<?php print $add_cart_text ?>" data-tipposition="top-center"
                                  onclick="mw.cart.add('.mw-add-to-cart-<?php print $item['id'] . $count ?>');"></span>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
                <?php if (is_array($item['prices'])): ?>
